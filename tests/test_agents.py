...
def minimal_signals() -> SignalsModel:
    ...
    return SignalsModel(
        ...
        capital_efficiency=CapitalEfficiencyModel(roce_latest=18.0, roce_trend="improving", ebit_interest_coverage=5.0),
        balance_sheet_health=BalanceSheetHealthModel(debt_to_equity_latest=0.3, debt_trend="declining", ebit_interest_coverage=5.0),
